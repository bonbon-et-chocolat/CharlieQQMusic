    ...
    songs.forEach( ( cur ) => {
        if( cur && cur.singer ) {
            result = result.concat( cur.singer.data.songList.filter( ( song )=> {
                if( song.songInfo.mid === '002e0ehD0bT1Ba' ) {
                    guojige = true;
                }
    ...
    if( mid === MID ) {
        ...
        if( !guojige ) {
            result.push({ // eslint-disable-next-line max-len
                'songInfo': { 'id': 313784929, 'type': 0, 'mid': '002e0ehD0bT1Ba', 'name': '国际歌', 'title': '国际歌', 'subtitle': '《1921》电影主题曲', 'singer': [ { 'id': 138, 'mid': '0019iLuN2glWFi', 'name': '孙楠', 'title': '孙楠', 'type': 0, 'uin': 0 }, { 'id': 199509, 'mid': '003fA5G40k6hKc', 'name': '周深', 'title': '周深', 'type': 0, 'uin': 0 } ], 'album': { 'id': 20262381, 'mid': '002UYBxp46Cu2g', 'name': '国际歌', 'title': '国际歌', 'subtitle': '《1921》电影主题曲', 'time_public': '2021-06-25', 'pmid': '002UYBxp46Cu2g_2' }, 'mv': { 'id': 0, 'vid': '', 'name': '', 'title': '', 'vt': 0 }, 'interval': 212, 'isonly': 1, 'language': 0, 'genre': 0, 'index_cd': 0, 'index_album': 1, 'time_public': '2021-06-25', 'status': 0, 'fnote': 4009, 'file': { 'media_mid': '004a3mp9074Txp', 'size_24aac': 0, 'size_48aac': 1293014, 'size_96aac': 2585832, 'size_192ogg': 4688147, 'size_192aac': 5147505, 'size_128mp3': 3401543, 'size_320mp3': 8503059, 'size_ape': 0, 'size_flac': 27190132, 'size_dts': 0, 'size_try': 960887, 'try_begin': 0, 'try_end': 0, 'url': '', 'size_hires': 0, 'hires_sample': 0, 'hires_bitdepth': 0, 'b_30s': 0, 'e_30s': 60000, 'size_96ogg': 2388188 }, 'pay': { 'pay_month': 1, 'price_track': 0, 'price_album': 0, 'pay_play': 0, 'pay_down': 0, 'pay_status': 0, 'time_free': 1 }, 'action': { 'switch': 638847, 'msgid': 0, 'alert': 0, 'icons': 131072, 'msgshare': 0, 'msgfav': 0, 'msgdown': 0, 'msgpay': 0 }, 'ksong': { 'id': 21004094, 'mid': '001y4FhO2nKhWA' }, 'volume': { 'gain': -9.628, 'peak': 1, 'lra': 6.259 }, 'label': '0', 'url': '', 'bpm': 0, 'version': 0, 'trace': '', 'data_type': 0, 'modify_stamp': 0, 'pingpong': '', 'ppurl': '', 'tid': 0, 'ov': 0, 'sa': 0, 'es': '' }
            });
        }
        result.push(
